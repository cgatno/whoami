...
const PDFDownloadLink = styled("a")`
  ...
  right: ${props => (props.stick ? "0" : "calc((100% - 960px) / 2)")};
        ...
        <Wrapper>
          ...
          <Section>
            ...
            <p>
              ...
              combining accredited biochemistry background with years of
              software development experience to deliver innovative, tested
              infrastructure solutions and engaging, delightful web experiences.
              Eager to collaborate with dedicated team members on cutting edge
              projects that push the boundaries of web technology to deliver
              novel products.
            </p>
          </Section>
          <Section>
            ...
            <SubSection>
              ...
              <ul>
                <li>
                  Created product samples for JavaScript UI control product
                  line, Wijmo
                </li>
                <li>
          ...
          <Section>
            ...
            <SubSection>
              ...
              <ul>
                <li>
                  Hands-on, independent research and iterative project
                  development
                </li>
